...
void ThroughputTest::run_put_operation(int num_iterations) {
    ...
    std::cout << "Put operation completed " << num_iterations << " iterations in " << duration << " microseconds" << std::endl;
}
...
void ThroughputTest::run_get_operation(int num_iterations) {
    ...
    std::cout << "Get operation completed " << num_iterations << " iterations in " << duration << " microseconds" << std::endl;
}
